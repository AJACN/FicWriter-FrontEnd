...
function limparCamposPersonagens() {
    divPersonagens.innerHTML = ''; // Remove todos os personagens
    divPersonagens.appendChild(criarLinhaPersonagem()); // Adiciona apenas um novo
    inputGenero.value = '';
    inputCenario.value = '';
    selectIdioma.value = 'Português';
    atualizarBotoesRemover();
    divResposta.classList.add('hidden'); // Oculta a resposta ao limpar
}
...
async function enviarFormulario() {
    ...
    }).filter(p => p); // Remove personagens com nome vazio
